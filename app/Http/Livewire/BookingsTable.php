    ...
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
           ...
           /** Example of custom column using a closure **/
            ->addColumn('product_name_lower', fn ($model) => strtolower(e($model->product_name)))

            ->addColumn('traveler_name')
            ->addColumn('booking_date_formatted', fn ($model) => Carbon::parse($model->booking_date)->format('d/m/Y'))
            ->addColumn('status')
            ->addColumn('price')
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Traveler name', 'traveler_name')
                ->sortable()
                ->searchable(),
    ...
    public function filters(): array
    {
        return [
            ...
            Filter::inputText('traveler_name')->operators(['contains']),
